...
This project uses the following Toss libraries:

- **es-toolkit**: Modern JavaScript utility library (Lodash replacement)
- **es-hangul**: Korean text processing (josa, getChoseong, etc.)
- **overlay-kit**: Declarative overlay/modal management for React
